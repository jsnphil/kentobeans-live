    ...
    <Navbar fluid rounded>
      <Navbar.Brand
        as={{
          ...
          default: '[Circular]',
          render: function LinkComponent(props, forwardedRef) {
            let children;
            const {
              href: hrefProp,
              as: asProp,
              ...
              legacyBehavior: legacyBehavior = !1,
              ...restProps
            } = props;
            (children = childrenProp),
              !legacyBehavior ||
            ...
            const { href: href, as: as } = _react.default.useMemo(() => {
                if (!pagesRouter) {
                  ...
                  router &&
                    (e.defaultPrevented ||
                      (function linkClicked(
                        ...
                        const { nodeName: nodeName } = e.currentTarget;
                        if (
